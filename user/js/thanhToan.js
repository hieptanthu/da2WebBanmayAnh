...
function DatHang() {
  ...
  if (listSpDatHang.length==0) {
    ...
    printHtml(str);
    window.location = "/user/html/gioHang.html"
...
function LoadData() {
  ...
  var sp = document.getElementById("sphamdd");
  ...
  // Append the total to the 'tt' element
  if (tt) {
    tt.innerHTML = t + 'đ';
  }
}
